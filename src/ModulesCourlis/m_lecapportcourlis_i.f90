...
! Variables locales
!  integer :: NbApports    ! Nombre d'apports  ! PU2017 : Mis en commentaire
!  integer :: iApport    ! Numero ou indice de l'apport  ! PU2017 : Mis en commentaire
!  integer :: LoiVaseAmont  ! Numero de la loi pour la CL amont en vase  ! PU2017 : Mis en commentaire
!  integer :: LoiSableAmont  ! Numero de la loi pour la CL amont en sable  ! PU2017 : Mis en commentaire
!  character(72) :: txt    ! Chaine de caractere temporaire  ! PU2017 : Mis en commentaire

! Traitement des erreurs
!  integer      :: retour           ! Code de retour Read  ! PU2017 : Mis en commentaire
