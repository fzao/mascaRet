...
!
!*************************************************************************
!  Modifiée le 21/10/2003	par	Ch. Bertier
...
! PU2017 : Mise en commentaire des constantes sur les mots cles
...
!  real(DOUBLE)  :: CoteMax			! Cote extreme maximum d'un profil
...
! PU2017 : Mise en commentaire des variables locales pour traitement erreur
!  integer		 :: retour		    ! Code de retour de la fonction read, allocate
!  integer        :: Retour_L			! Code re retour a la 2ieme lecture du fichier
!  character(132) :: arbredappel_old ! Arbre d'appel initial
