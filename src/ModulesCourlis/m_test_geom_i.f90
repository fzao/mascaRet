...
use M_PARAMETRE_C      ! Parametres num̩riques
...
! Variables locales
!  integer      :: iProf    ! Compteur sur les profils  ! PU2017 : Mis en commentaire
!  integer      :: iPoint    ! Compteur sur les points d'un profil  ! PU2017 : Mis en commentaire
!  integer      :: iInterf    ! Compteur sur les interfaces de couches  ! PU2017 : Mis en commentaire
!  integer      :: NbPoints    ! Nombre de points d'un profil  ! PU2017 : Mis en commentaire
!  integer      :: NbPointsCourlis  ! Nombre de points d'un profil Courlis  ! PU2017 : Mis en commentaire
!  character(30)    :: NomProf    ! Nom du profil  ! PU2017 : Mis en commentaire
!  character(30)    :: NomBief    ! Nom du bief  ! PU2017 : Mis en commentaire
!  real(DOUBLE)    :: Abs        ! Abscisse relative du profil  ! PU2017 : Mis en commentaire
!  real(DOUBLE)    :: CoteMax      ! Cote extreme maximum d'un profil  ! PU2017 : Mis en commentaire
!  logical      :: LimMin1,LimMin2  ! Tests de Limites inferieures  ! PU2017 : Mis en commentaire
