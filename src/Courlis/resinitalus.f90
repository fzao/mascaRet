...
!=========================================================================
!
!  Fonction :  Calcul de la résistance initiale des colonnes sédimentaires
!  --------    au mouvements
!
...
! Allocations des tableaux locaux dépendant de NPt et initialisation
!=========================================================================
...
!    Enddo  ! PU2017 : Mise en commentaire
  ...
  ! Calcul de la résistance initiale
    ResIni(j,i) = (1.468_DOUBLE * HsM + 0.162_DOUBLE) * DxzF !!!!Cette formule de la résistance initiale
